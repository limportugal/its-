...
<head>
    ...
    <title>Page Not Found - EMS</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="error-container">
        <div class="error-illustration">
            <svg width="200" height="160" viewBox="0 0 200 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                <!-- 3D Animated Robot/Space Theme with Blue Theme -->
                <defs>
                ...
                <!-- Question Mark -->
                <path d="M90 130 Q100 120 110 130 Q105 140 100 145 M100 150 L100 155" stroke="url(#grad2)" stroke-width="3" fill="none" stroke-linecap="round">
        ...
        <p class="error-message">
            @if(auth()->check())
                The page you're looking for is not available in our system records.<br>Let's get you back to your dashboard!
            @else
                The page you're looking for is not available in our system records.<br>Please log in to access your account.
            @endif
        </p>
