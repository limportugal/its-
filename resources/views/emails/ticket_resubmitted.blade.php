...
<head>
    ...
    <title>Ticket Resubmitted</title>
    <style>
        /* General Styles */
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Hi, {{ $full_name }}!</h1>
            <p>Your ticket has been successfully resubmitted.</p>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" class="section-divider">
                            <div class="section-title">🔄 RESUBMISSION DETAILS</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $resubmission_reason }}</td>
                    </tr>

                    <!-- RESUBMITTED DATE -->
                    <tr>
                        <th>📅 Resubmitted Date</th>
                        <td>{{ date('M. d, Y h:i A', strtotime($resubmittedAt)) }}</td>
                    </tr>
        ...
        <div class="message">
            ...
            Our team will review your resubmitted ticket and get back to you as soon as possible. Please keep your ticket number for future reference.
        </div>
