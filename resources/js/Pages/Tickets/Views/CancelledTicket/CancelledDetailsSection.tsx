...
interface CancelledDetailsSectionProps {
    cancelledDetails: DetailField[];
    status: string;
    tableCellHeaderStyle: any;
    tableCellStyle: any;
}

const CancelledDetailsSection: React.FC<CancelledDetailsSectionProps> = ({
    cancelledDetails,
    status,
    ...
    return (
        <Box>
            ...
            >
                <Table>
                    <TableBody>
                        {cancelledDetails.map((field, index) => (
                            <TableRow key={index}>
                                <TableCell
                                    component="th"
                                    sx={{
                                        ...
                                        py: 3,
                                        px: 2,
                                        ...(index === cancelledDetails.length - 1 && {
                                            borderBottom: 'none'
                                        })
                                    }}
                                >
...
export default CancelledDetailsSection;
