...
interface ReminderDetailSectionProps {
    reminderDetails: DetailField[];
    status: string;
    tableCellHeaderStyle: any;
    tableCellStyle: any;
}

const ReminderDetailSection: React.FC<ReminderDetailSectionProps> = ({
    reminderDetails,
    status,
    ...
    return (
        <Box>
            ...
            >
                <Table>
                    <TableBody>
                        {reminderDetails.map((field, index) => (
                            <TableRow key={index}>
                                <TableCell
                                    component="th"
                                    sx={{
                                        ...
                                        py: 3,
                                        px: 2,
                                        ...(index === reminderDetails.length - 1 && {
                                            borderBottom: 'none'
                                        })
                                    }}
                                >
...
export default ReminderDetailSection;
