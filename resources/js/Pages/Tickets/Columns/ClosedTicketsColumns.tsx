...
const DescriptionCell = React.memo(({ row, value }: { row: ClosedTicketsResponse; value: any }) => {
    ...
    return (
        <DescriptionTooltip
            ...
            powerform_client_name={row.powerform_client_name}
            powerform_store_code={row.powerform_store_code}
            powerform_store_name={row.powerform_store_name}
            powerform_store_address={row.powerform_store_address}
            powerform_store_ownership={row.powerform_store_ownership}
            powerform_store_type={row.powerform_store_type}
