    ...
    },
    {
        ...
        renderCell: (params) => (
            <DescriptionTooltip
                ...
                powerform_client_name={params.row.powerform_client_name}
                powerform_store_code={params.row.powerform_store_code}
                powerform_store_name={params.row.powerform_store_name}
                powerform_store_address={params.row.powerform_store_address}
                powerform_store_ownership={params.row.powerform_store_ownership}
                powerform_store_type={params.row.powerform_store_type}
