...
export default function Error403({ 
    ...
    return (
        <>
            <Head title="Access Forbidden - EMS" />
                ...
                <div className="text-center relative z-10 w-full mx-auto p-3 sm:p-4 md:p-6 lg:p-6 xl:p-8">
                    ...
                    <div className="mb-4 sm:mb-6" style={{ animation: 'bounce 2s ease-in-out infinite' }}>
                        <svg width="120" height="100" viewBox="0 0 200 160" fill="none" className="mx-auto sm:w-32 sm:h-28 md:w-36 md:h-32 lg:w-40 lg:h-36 xl:w-44 xl:h-40">
                            ...
                            <circle cx="100" cy="65" r="8" fill="none" stroke="url(#grad2)" strokeWidth="3" opacity="0.9" />
                            ...
                            <path d="M57 37 L63 37 M60 34 L60 43" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" />
                            ...
                            <path d="M137 57 L143 57 M140 54 L140 63" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" />
                            ...
                            {/* X mark */}
                            <path d="M85 45 L115 45 M100 35 L100 55" stroke="url(#grad1)" strokeWidth="4" fill="none" strokeLinecap="round" opacity="0.6">
