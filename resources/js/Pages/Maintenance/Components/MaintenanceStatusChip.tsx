...
const MaintenanceStatusChip: React.FC<{ status: string | undefined | null }> = ({ status }) => {
    ...
    const statusStyle = statusStyles[safeStatus as keyof typeof statusStyles] || {
        bg: "#f8f9fa",
        text: "#6c757d", 
    ...
    return (
        <Tooltip title={description} arrow>
            <Chip
                label={snakeCaseToTitleCase(safeStatus)}
