...
use App\Mail\TicketAssignedToCreatorNotification;
...
class SendTicketAssignedToCreatorEmail implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Mail::to($ticket->email)
            ->send(new TicketAssignedToCreatorNotification($ticket));
    }
}
